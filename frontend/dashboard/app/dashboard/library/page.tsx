...
export default function LibraryPage() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: '18px', fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--text)', margin: '0 0 8px' }}>Library</h1>
      <p style={{ fontSize: '13px', color: 'var(--text-3)', margin: '0 0 28px', maxWidth: '320px', lineHeight: 1.6 }}>
        Browse your saved call snippets, objection responses and winning playbooks.
      </p>
